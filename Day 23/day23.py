...
def main():
    assert day23('test23') == 110
    print(f"Part 1: {day23('input23')}")

    assert day23('test23', True) == 20
    print(f"Part 2: {day23('input23', True)}")
